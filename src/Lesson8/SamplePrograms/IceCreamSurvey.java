...
public class IceCreamSurvey {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nHere is a list of chocolate people an i dont mean black");
        for (int i = 0; i < cpeople.length; i++) {
            System.out.print(cpeople[i]+", ");
        }
        System.out.println("\nHere is a list of vanilla people an i dont mean white");
        for (int i = 0; i < vpeople.length; i++) {
            System.out.print(vpeople[i]+", ");
        }
        System.out.println("\nHere is a list of strawberry people a");
    ...
    public static String[] filter(String data[][],String flav){
        String results = "";
        ////// go through data looking for flav in spot [1]
        for (int i = 0; i < data.length; i++) {
            if(flav.equals(data[i][1]))
                results += data[i][0]+","; //Matt,Jason,Luke...
        }
